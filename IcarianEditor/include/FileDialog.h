...
public:
    ...
    static bool FileExplorer(const std::list<std::filesystem::path>& a_dirs, const std::list<std::filesystem::path>& a_files, std::filesystem::path* a_path, std::string* a_name, const glm::vec2& a_size = glm::vec2(-1.0f, -1.0f));
};