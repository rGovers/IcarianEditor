...
cd bin/build
cmake -DCMAKE_BUILD_TYPE=Debug -DGENERATE_CONFIG=ON ../../IcarianEngine/IcarianNative/
make -j6
echo
echo "------------------------"
echo
...
echo "------------------------"
echo
../../IcarianEngine/deps/flare-mono/build/bin/xbuild ../../IcarianEditorCS/IcarianEditorCS.csproj /p:Configuration=Debug
cd ..
...
cd build
cmake -DCMAKE_BUILD_TYPE=Debug ../IcarianEditor
echo
make -j6
